...
<html class="no-js" lang="en">
    ...
    <body class="left-nav-sidebar">
        ...
        <section id="home" class="p-0 parallax mobile-height wow fadeIn" data-stellar-background-ratio="0.5" style="">
                        ...
                        <div class="slider-text-middle">
                            <div class="bg-black-opacity-light w-50 mx-auto md-width-80">
                                <div class="padding-fifteen-all sm-padding-20px-all">
                                    ...
                                    <h6 class="text-uppercase text-deep-pink font-weight-600 alt-font d-block margin-5px-bottom">Хуудас олдсонгүй!</h6>
                                    <span class="text-medium-gray width-60 d-block mx-auto text-large md-width-100">Таны хайсан хуудас олдсонгүй.</span>
                                    ...
                                    <a href="/" class="btn btn-transparent-white btn-medium text-extra-small border-radius-4"><i class="ti-arrow-left margin-5px-right ml-0" aria-hidden="true"></i> Нүүр хуудасруу буцах</a>
                                </div>
                            </div>                            
                        </div>
                    </div>
