    ...
    <head>
        ...
        <link rel="shortcut icon" href="images/image copy 4.png">
            ...
            <nav class="navbar navbar-expand-lg background-white header-light-transparent navbar-banner">
                <div class="container-fluid nav-header-container">
                    <div class="brand-logo"><a href="#home" title="Ashid Soft LLC" class="logo"><img
                                src="images/image.png" alt="Ashid Soft LLC"></a></div>
            <button
        type="button"
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-toggle-1">
        <ul id="accordion" class="navbar-nav alt-font text-normal mx-auto">
            ...
            <li class="nav-item">
                <a href="#about" class="nav-link inner-link">Ашид Дентал</a>
            </li>
            <li class="nav-item">
                <a href="#Веб" class="nav-link inner-link">Эмчийн Веб</a>
            </li>
            <li class="nav-item">
    ...
    <div class="header-actions">
        ...
        <a href="{{ route('login') }}" class="btn btn-very-small text-white" style="background-color: rgb(215, 115, 29); padding: 5px 15px; border-radius: 25px;">
    <i class="fa-solid fa-right-to-bracket"></i> Нэвтрэх
        ...
        <section id="home" class="wow fadeIn p-0 parallax sm-background-image-center hero-section"
            style="background-image:url('images/image copy 6.png');">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-8 col-md-8 sm-margin-15px-bottom wow fadeIn">
                    <img src="images/image copy.png" class="about-img">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="workflow-timeline-container">
        ...
        <section class="wow fadeIn">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 wow fadeInLeft"><img src="images/image copy 2.png" class="width-100"
                            alt="Showcase" /></div>
    ...
    <section class="wow fadeIn doctor-web-section" id="Веб">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8 col-md-10 mx-auto">
                    <div class="doctor-web-content">

                        <h3 class="doctor-web-title">Эмчийн Веб</h3>

                        <p class="doctor-web-description">
                            Ашид Софт Програм хангамж нь Ashid Dental шүдний эмнэлгийн
                            програмын веб хувилбар болох Эмчийн Веб системийг гаргасан.
                            Энэхүү систем нь website хэлбэртэй тул утас, таблет, компьютероос
                            шууд ашиглах боломжтойгоороо давуу талтай.
                        </p>

                        <h4 class="doctor-web-subtitle">Эмчийн Веб нь юу хийдэг вэ?</h4>

                        <ul class="doctor-web-feature-list">
                            <li class="doctor-web-feature-item">Өвчтөн бүртгэх</li>
                            <li class="doctor-web-feature-item">Цаг товлох</li>
                            <li class="doctor-web-feature-item">Дахин дуудах хуваарь</li>
                            <li class="doctor-web-feature-item">Эмчилгээ оруулах</li>
                            <li class="doctor-web-feature-item">Төлбөрийн мэдээлэл</li>
                        </ul>

                        <h5 class="doctor-web-cta-title">Эмчийн WEB лүү зочлох</h5>

                        <a href="http://5.75.183.40:8081/"
                        class="btn btn-medium btn-rounded btn-deep-pink doctor-web-button">
                            Эмчийн Веб
        ...
        <section class="clients-section" >
            ...
            <div class="clients-wrapper">
                ...
                <input type="checkbox" id="show-clients" hidden>
                <label for="show-clients" class="toggle-hidden-clients-wrapper-button">
        Бүгдийг харах
    </label>
    <div class="hidden-clients-wrapper">             
                <img src="images/image copy 31.jpg"> 
                <img src="images/image copy 30.jpg">
                <img src="images/copy image 22.jpg">    
                <img src="images/image copy 23.jpg">
                <img src="images/image copy 24.jpg">
                <img src="images/image copy 25.jpg">
                <img src="images/image copy 26.jpg">
                <img src="images/image copy 27.jpg">
                <img src="images/image copy 28.jpg">
                <img src="images/image copy 29.jpg">
                <img src="images/khashaa.jpg">
                <img src="images/ever bro.jpg">
        </div>
        </section>
        ...
        <div class="container">
            <div class="web-dev-layout">
                ...
                <div class="web-dev-image">
                    <img src="images/image copy 3.png" alt="Вэб сайт хөгжүүлэлт">
                </div>
